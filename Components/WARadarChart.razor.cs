...
{
    public partial class WARadarChart : WAComponentBase
    {
        #region Parameters

        private RadarChartOptions ChartOptions { get; set; } = new();
        private RadarChartDataSet[] DataSets = [];
        ...
        protected override string? StyleNames => BuildStyleNames(Style,
            [.. DataSets
                ...
                .Concat(
                    [
                        ((string?)$"--line-border-width: {ChartOptions.LineBorderWidth}", !string.IsNullOrWhiteSpace(ChartOptions.LineBorderWidth)),
        ...
        public async Task RenderChartAsync(string[] categoryLabels, RadarChartDataSet[] dataSets, RadarChartOptions? radarChartOptions = null)
        {
            DataSets = dataSets;
    ...
    public class RadarChartOptions
    {
        ...
        /// </summary>
        public string? LineBorderWidth { get; set; }
