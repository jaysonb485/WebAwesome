...
{
    public partial class WALineChart : WAComponentBase
    {
        #region Parameters

        private LineChartOptions ChartOptions { get; set; } = new();
        private LineChartDataSet[] DataSets = [];
        ...
        public async Task RenderChartAsync(string[] categoryLabels, LineChartDataSet[] dataSets, LineChartOptions? lineChartOptions = null)
        {
            DataSets = dataSets;
