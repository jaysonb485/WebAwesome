...
{
    public partial class WAPolarAreaChart : WAComponentBase
    {
        #region Parameters

        private PolarAreaChartOptions ChartOptions { get; set; } = new();
        private PolarAreaChartDataSet DataSet = new();
        ...
        public async Task RenderChartAsync(string[] categoryLabels, PolarAreaChartDataSet dataSet, PolarAreaChartOptions? polarAreaChartOptions = null)
        {
            DataSet = dataSet;
